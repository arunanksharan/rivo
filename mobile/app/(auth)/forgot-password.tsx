      ...
      <View style={styles.contentContainer}>
        {!isSubmitted ? (
          <>
            ...
            <View style={styles.formContainer}>
              ...
              <TouchableOpacity 
                ...
                onPress={handleBackToLogin}
              >
                <Text variant="body2" color={theme.colors.primary}>Back to Login</Text>
              </TouchableOpacity>
            </View>
          </>
        ) : (
          <View style={styles.successContainer}>
            ...
            <Text variant="h2" style={styles.successTitle}>Email Sent</Text>
            
            <Text variant="body1" color={theme.colors.textLight} style={styles.successText}>
            ...
            <Text variant="body2" color={theme.colors.textLight} style={styles.instructionText}>
            ...
            <TouchableOpacity 
              ...
              onPress={handleResetPassword}
            >
              <Text variant="body2" color={theme.colors.primary}>Didn't receive the email? Resend</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
